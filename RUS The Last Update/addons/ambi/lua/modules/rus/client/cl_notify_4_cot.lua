...
Notify.Add( 4, 'Official Capture Of Terra Notify', 'Ambi', function( tVars )
    ...
    if id then
        ...
        local notify = GUI.DrawPanel( nil, 12 + textw, 32, w + 28, y, function( self, w, h ) 
            ...
            draw.SimpleTextOutlined( text, '20 Ambi', w - 6, h / 2, textcolor, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER, 1, C.ABS_BLACK )
        end )
        ...
        local icon = GUI.DrawPanel( nil, 28, 32, w, y, function( self, w, h )
            ...
            draw.SimpleTextOutlined( chars[ type ], '26 Ambi', w / 2 - 1, h / 2, textcolor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, C.ABS_BLACK )
        end )
