...
RunConsoleCommand( 'sitting_ent_mode', '3' )
--[[
...
local SittingOnPlayer = CreateConVar("sitting_can_sit_on_players","0",{FCVAR_NOTIFY, FCVAR_ARCHIVE})
RunConsoleCommand( 'sitting_can_sit_on_players', '0' )

local SittingOnPlayer2 = CreateConVar("sitting_can_sit_on_player_ent","1",{FCVAR_NOTIFY, FCVAR_ARCHIVE})
local PlayerDamageOnSeats = CreateConVar("sitting_can_damage_players_sitting","1",{FCVAR_NOTIFY, FCVAR_ARCHIVE})
RunConsoleCommand( 'sitting_can_damage_players_sitting', '1' )

local AllowWeaponsInSeat = CreateConVar("sitting_allow_weapons_in_seat","1",{FCVAR_NOTIFY, FCVAR_ARCHIVE})
RunConsoleCommand( 'sitting_allow_weapons_in_seat', '1' )
