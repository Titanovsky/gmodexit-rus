...
local FONT, FONT_NUM = '18 Ambi', '20 Ambi'
...
hook.Add( 'HUDPaint', 'Ambi.InfoHUD.Draw', function()
    ...
    local color = ( AMB.InfoHUD.Config.fpp_enable and FPP ) and ( FPP.canTouchEnt( ent, weaponClassTouchTypes[ wep:IsValid() and wep:GetClass() or "" ] or 'EntityDamage' ) and C.AMBI_GREEN or C.AMBI_RED ) or C.ABS_WHITE
