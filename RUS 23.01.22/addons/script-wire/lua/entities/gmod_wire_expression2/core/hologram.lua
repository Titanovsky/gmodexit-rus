...
local wire_holograms_max = CreateConVar( "wire_holograms_max", "2048", {FCVAR_ARCHIVE} )
local wire_holograms_spawn_amount = CreateConVar( "wire_holograms_spawn_amount", "60", {FCVAR_ARCHIVE} ) -- This limit resets once a second
local wire_holograms_burst_amount = CreateConVar( "wire_holograms_burst_amount", "128", {FCVAR_ARCHIVE} ) -- This limit goes down first, resets every burst_delay
local wire_holograms_burst_delay = CreateConVar( "wire_holograms_burst_delay", "5", {FCVAR_ARCHIVE} )
...
local wire_holograms_modelany = CreateConVar( "wire_holograms_modelany", "1", {FCVAR_ARCHIVE},
...
local wire_holograms_size_max = CreateConVar( "wire_holograms_size_max", "1024", {FCVAR_ARCHIVE} )
