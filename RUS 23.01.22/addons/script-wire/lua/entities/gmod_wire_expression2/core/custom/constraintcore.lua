...
e2function void axis(entity ent1, vector v1, entity ent2, vector v2)
	if not self.player:CheckAccess( 2, 'axis' ) then return end
...
e2function void ballsocket(entity ent1, vector v, entity ent2)
	if not self.player:CheckAccess( 2, 'ballsocket' ) then return end
...
e2function void weldAng(entity ent1, vector v, entity ent2)
	if not self.player:CheckAccess( 2, 'weldAng' ) then return end
...
e2function void winch(index, entity ent1, vector v1, entity ent2, vector v2, width)
	if not self.player:CheckAccess( 2, 'winch' ) then return end
...
e2function void hydraulic(index, entity ent1, vector v1, entity ent2, vector v2, width)
	if not self.player:CheckAccess( 2, 'hydraulic' ) then return end
...
e2function void rope(index, entity ent1, vector v1, entity ent2, vector v2)
	if not self.player:CheckAccess( 2, 'rope' ) then return end
...
e2function void entity:setLength(index, length)
	if not self.player:CheckAccess( 2, 'setLength' ) then return end
...
e2function void entity:setConstant(index, constant)
	if not self.player:CheckAccess( 2, 'setConstant' ) then return end
...
e2function void entity:setDamping(index, damping)
	if not self.player:CheckAccess( 2, 'setDamping' ) then return end
...
e2function void slider(entity ent1, vector v1, entity ent2, vector v2)
	if not self.player:CheckAccess( 2, 'slider' ) then return end
...
e2function void noCollide(entity ent1, entity ent2)
	if not self.player:CheckAccess( 2, 'noCollide' ) then return end
...
e2function void noCollideAll(entity ent, state)
	if not self.player:CheckAccess( 2, 'noCollideAll' ) then return end
...
e2function void weld(entity ent1, entity ent2)
	if not self.player:CheckAccess( 2, 'weld' ) then return end
...
e2function void entity:constraintBreak()
	if not self.player:CheckAccess( 2, 'constraintBreak' ) then return end
