...
function SetE2DLight(self,this,pos,color,brightness,size,delay)
	if not self.player:CheckAccess( 2, 'any methods E2DLight' ) then return end
...
e2function void entity:dLightPos(vector pos)
	if not self.player:CheckAccess( 2, 'dLightPos' ) then return end
	if !IsValid(this)  then return end
...
if not self.player:CheckAccess( 2, 'dLightColor' ) then return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
...
if not self.player:CheckAccess( 2, 'dLightBrightness' ) then return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
...
if not self.player:CheckAccess( 2, 'dLightSize' ) then return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
...
if not self.player:CheckAccess( 2, 'dLightDelay' ) then return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
...
if not self.player:CheckAccess( 2, 'dLightReParent' ) then return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
...
if not self.player:CheckAccess( 2, 'dLightRemove' ) then return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
...
e2function entity entity:setfLight(vector pos,vector color,angle ang,string material,number fov,number farz,number nearz)
	...
	if not self.player:CheckAccess( 2, 'any methods setfLight' ) then return end
	if !IsValid(this)  then return end
