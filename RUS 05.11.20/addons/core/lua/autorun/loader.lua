...
AMB.loadScripts( "lib", 	"| [AMB] Custom Library |" ) -- библиотека
AMB.loadScripts( "gm", 		"| [AMB] Gamemode Structure |" ) -- настройки геймода
AMB.loadScripts( "player",  "| [AMB] Main Information of Player |" )
AMB.loadScripts( "orgs", 	"| [AMB] Organisations v1.1 |" ) -- организаций
AMB.loadScripts( "ui", 		"| [AMB] User Interface |" )
AMB.loadScripts( "cmds", 	"| [AMB] CMDs |" )
AMB.loadScripts( "duel", 	"| [AMB] Duel (1vs1) System |" )
...
AMB.loadScripts( "propcore", "| [AMB]" )
--AMB.loadScripts( "adminus", "| [AMB] Adminus |") -- админка, готова на 70%
