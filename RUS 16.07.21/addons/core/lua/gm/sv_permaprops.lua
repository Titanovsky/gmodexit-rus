...
AmbPermaProps.Entities = {
	...
	{ class = 'amb_npc_shop_skin', pos = Vector( -4158, -2999, 250 ), ang = Angle( 0, -125, 0 ), map = 'gm_construct' },
...
hook.Add( 'PostCleanupMap', 'SpawnEntsAfterCleanUp', AmbPermaProps.Spawn )
hook.Add( 'InitPostEntity', 'SpawnPermaEnts', function()

	timer.Simple( 1, AmbPermaProps.Spawn )
