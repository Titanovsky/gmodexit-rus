...
function ENT:DrawTranslucent()
	...
	if imgui.Entity3D2D( self, Vector( 14, 0, 35.4 ), Angle( 0, 90, 0 ), 0.1, 600 ) then
		...
		draw.SimpleTextOutlined( 'Верстак для Винтовки', 'ambFont32', -12, -36, AMB_COLOR_WHITE, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, AMB_COLOR_BLACK )

		if imgui.xTextButton( 'Скрафтить', font, -60, 28, 108, 36, 2, AMB_COLOR_GREEN, COLOR_GREEN, AMB_COLOR_GREEN ) and ( LocalPlayer():GetPos():Distance( self:GetPos() ) <= 82 ) then
