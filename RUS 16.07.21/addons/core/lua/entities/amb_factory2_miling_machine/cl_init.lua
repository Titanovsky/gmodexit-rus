...
function ENT:DrawTranslucent()
	...
	if imgui.Entity3D2D( self, Vector( 14.8, 0, 20 ), Angle( 0, 90, 0 ), 0.1, 600 ) then
		...
		draw.SimpleTextOutlined( 'Фрезерный Станок', 'ambFont32', -12, 52, AMB_COLOR_WHITE, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, AMB_COLOR_BLACK )
		...
		if imgui.xTextButton( 'Сделать Деталь', font, -90, 120, 160, 36, 2, condition_color, COLOR_GREEN, condition_color ) and ( LocalPlayer():GetPos():Distance( self:GetPos() ) <= 82 ) then
