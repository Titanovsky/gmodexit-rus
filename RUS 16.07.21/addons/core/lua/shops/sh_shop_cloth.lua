...
AmbShopCloth.SpecModels = {
    ...
    ['models/player/kerry/policeru_01.mdl'] = 3000,
    ['models/player/kerry/police_01_female.mdl'] = 3000,
    ['models/player/kerry/policeru_01_omon.mdl'] = 3000,
    ['models/player/kerry/policeru_01_patrol.mdl'] = 3000,
    ['models/player/kerry/policeru_01.mdl'] = 3000,

    ['models/player/dewobedil/umaru/umaru.mdl'] = 16284,
    ['models/CyanBlue/DarlingFranxx/ZeroTwo/ZeroTwo.mdl'] = 16284,
    ['models/pacagma/vocaloid/tda_rolling_girl_miku_v1/tda_rolling_girl_miku_v1_player.mdl'] = 16284,
    ['models/pacagma/vocaloid/tda_rolling_girl_miku_v1/tda_rolling_girl_miku_v1_injury_player.mdl'] = 16284,

    [ 'models/player/zelpa/male_02.mdl' ] = 18400,
    [ 'models/player/zelpa/male_04.mdl' ] = 18400,
    [ 'models/player/zelpa/male_05.mdl' ] = 18400,
    [ 'models/player/zelpa/male_06.mdl' ] = 18400,
    [ 'models/player/zelpa/male_07.mdl' ] = 18400,
    [ 'models/player/zelpa/male_08.mdl' ] = 18400,
    [ 'models/player/zelpa/male_09.mdl' ] = 18400,
    [ 'models/player/zelpa/male_10.mdl' ] = 18400,

    [ 'models/player/zelpa/female_01.mdl' ] = 18600,
    [ 'models/player/zelpa/female_02.mdl' ] = 18600,
    [ 'models/player/zelpa/female_04.mdl' ] = 18600,
    [ 'models/player/zelpa/female_06.mdl' ] = 18600,

    ['models/pacagma/vocaloid/tda_rolling_girl_miku_v1/tda_rolling_girl_miku_v1_player.mdl'] = 24999,
    ['models/player/Tuubiii.mdl'] = 32000,
    ['models/player/pyroteknik/kermit.mdl'] = 32000,
}
