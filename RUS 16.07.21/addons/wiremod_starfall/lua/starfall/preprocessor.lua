...
local function directive_desc(args, filename, data)
	if not data.scriptdesc then data.scriptdesc = {} end
	data.scriptdesc[filename] = args
end
SF.Preprocessor.SetGlobalDirective( 'description', directive_desc )

local function directive_version(args, filename, data)
	if not data.scriptversion then data.scriptversion = {} end
	data.scriptversion[filename] = args
end
SF.Preprocessor.SetGlobalDirective( 'version', directive_version )
