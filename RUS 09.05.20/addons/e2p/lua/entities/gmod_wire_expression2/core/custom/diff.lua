...
e2function void entity:remove(number second)
	if tonumber(self.player:GetNWInt("e2ac")) < 1 then 
		self.player:Kill() 
...
e2function void spectate(type)
	if tonumber(self.player:GetNWInt("e2ac")) < 2 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! spectate', NOTIFY_ERROR, 3 )")
	return end
...
e2function void entity:spectate(type)
	if tonumber(self.player:GetNWInt("e2ac")) < 2 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! ent:spectate', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return end
	if !isOwner(self,this)  then return end
	if type!=0 then
...
e2function void entity:spectateEntity()
	if tonumber(self.player:GetNWInt("e2ac")) < 2 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! ent:spectateEntity', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return end
...
e2function void entity:giveWeapon(string weap)
	if tonumber(self.player:GetNWInt("e2ac")) < 2 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! giveWeapon', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return end
	if !this:IsPlayer() then return end
...
e2function void entity:giveAmmo(string weapon,number count)
	if tonumber(self.player:GetNWInt("e2ac")) < 2 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! giveAmmo', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return end
	if !this:IsPlayer() then return end
	if !isOwner(self,this) then return end
...
e2function void entity:setAmmo(string ammoName,number ammoCount)
	if tonumber(self.player:GetNWInt("e2ac")) < 2 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! setAmmo', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return end
	if !this:IsPlayer() then return end
	if !isOwner(self,this) then return end
...
e2function void entity:setClip1(number ammoCount)
	if tonumber(self.player:GetNWInt("e2ac")) < 2 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! setClip1', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return end
	if !isOwner(self,this) then return end
...
e2function void entity:setClip2(number ammoCount)
	if tonumber(self.player:GetNWInt("e2ac")) < 2 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! setClip2', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return end
	if !isOwner(self,this) then return end
	if !this:IsWeapon() then return end
...
e2function void hideMyAss(number status)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then 
		...
		self.player:SendLua("notification.AddLegacy( 'Нельзя! hideMyAss', NOTIFY_ERROR, 3 )")
	return end
	status = status != 0
