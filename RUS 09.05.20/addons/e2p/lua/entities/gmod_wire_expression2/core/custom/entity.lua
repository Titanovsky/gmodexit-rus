...
local BlackListForCoders = {"game_end","lua_run","point_commentary_node","env_entity_maker","npc_maker","worldspawn","npc_template_maker","func_button","func_brush"}
local BlackListForPlayers = {"func_button","func_brush","env_entity_dissolver","env_entity_igniter","env_headcrabcanister","env_screenoverlay","script_intro","sky_camera","env_viewpunch","point_tesla","game"} -- Блеклист второй степени
