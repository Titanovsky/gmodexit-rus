...
money_set:addParam{ type=ULib.cmds.NumArg, min=0, max=9999, hint="Рубаксы", ULib.cmds.round }
...
money_add:addParam{ type=ULib.cmds.NumArg, min=1, max=9999, hint="Рубаксы", ULib.cmds.round }
...
function ulx.frisk_set( ply, targ, amount )
	for i=1, #targ do
		targ[ i ]:FC_set( amount )
	end
	ulx.fancyLogAdmin( ply, "#A изменил количество FC для #T на #i", targ, amount )
end
local frisk_set = ulx.command( CAT, "ulx set fc", ulx.frisk_set, "!setfc" )
frisk_set:addParam{ type=ULib.cmds.PlayersArg }
frisk_set:addParam{ type=ULib.cmds.NumArg, min=0, max=9999, hint="Фриск Коины", ULib.cmds.round }
frisk_set:defaultAccess( ULib.ACCESS_ADMIN )
frisk_set:help( "Изменить количество Фриск Коинов." )


function ulx.frisk_add( ply, targ, amount )
	for i=1, #targ do
		targ[ i ]:FC_add( amount )
	end
	ulx.fancyLogAdmin( ply, "#A добавил количество FC для #T по #i", targ, amount )
end
local frisk_add = ulx.command( CAT, "ulx add fc", ulx.frisk_add, "!addfc" )
frisk_add:addParam{ type=ULib.cmds.PlayersArg }
frisk_add:addParam{ type=ULib.cmds.NumArg, min=1, max=9999, hint="Фриск Коины", ULib.cmds.round }
frisk_add:defaultAccess( ULib.ACCESS_ADMIN )
frisk_add:help( "Добавить количество Фриск Коинов." )
...
lvl_set:defaultAccess( ULib.ACCESS_ADMIN )
...
lvl_add:defaultAccess( ULib.ACCESS_ADMIN )
...
exp_set:defaultAccess( ULib.ACCESS_ADMIN )
...
exp_add:defaultAccess( ULib.ACCESS_ADMIN )
