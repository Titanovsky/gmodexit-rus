...
e2function array entity:soundFFT(string id)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundFFT', NOTIFY_ERROR, 3 )")
    return end
	sendRequest(this,id)
...
e2function void soundURLload(string id,string url,volume, noplay, vector pos)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundURLload', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundURLplay(string id)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundURLplay', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundURLpause(string id)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundURLpause', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundURLvolume(string id, volume)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundURLvolume', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundURLpos(string id, vector pos)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundURLpos', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundURLparent(string id, entity tar)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundURLparent', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundURLdelete(string id)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundURLdelete', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundURLPurge()
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundURLPurge', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundPlayAll(string path,volume,pitch)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundPlayAll', NOTIFY_ERROR, 3 )")
    return end
...
e2function void soundPlayWorld(string path,vector pos,distance,pitch,volume)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundPlayWorld', NOTIFY_ERROR, 3 )")
    return end
	local path=path:Trim()
	if string.find(path:lower(),"loop",1,true) then return end
...
e2function void entity:soundPlaySingle(string path, number volume, number pitch)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
        self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! soundPlaySingle', NOTIFY_ERROR, 3 )")
    return end
