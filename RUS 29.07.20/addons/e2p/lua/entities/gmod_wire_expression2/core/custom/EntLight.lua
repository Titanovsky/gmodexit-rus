...
e2function entity entity:setdLight(vector pos,vector color,number brightness,number size,number delay)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! setdLight', NOTIFY_ERROR, 3 )")
	return end
...
e2function void entity:dLightPos(vector pos)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! dLightPos', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
...
e2function void entity:dLightColor(vector color)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! dLightColor', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:dLightBrightness(number brightness)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! dLightBrightness', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:dLightSize(number size)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! dLightSize', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:dLightDelay(number delay)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! dLightDelay', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:dLightReParent(entity parent)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! dLightReParent', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:dLightRemove()
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! dLightRemove', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_dlight)  then return end
if !isOwner(self,this)  then return end
...
e2function entity entity:dLightRemove()
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! dLightRemove', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
...
e2function entity entity:setfLight(vector pos,vector color,angle ang,string material,number fov,number farz,number nearz)
	...
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! setfLight', NOTIFY_ERROR, 3 )")
	return end
...
e2function void entity:fLightPos(vector pos)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! fLightPos', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
...
e2function void entity:fLightAng(angle ang)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! fLightAng', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_flight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:fLightColor(vector color)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! fLightColor', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_flight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:fLightMaterial(string material)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! fLightMaterial', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_flight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:fLightFOV(number fov)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! fLightFOV', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_flight)  then return end
if !isOwner(self,this)  then return end
...
e2function void entity:fLightReParent(entity parent)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! fLightReParent', NOTIFY_ERROR, 3 )")
	return end
if !IsValid(this)  then return end
if !IsValid(this.e2_flight)  then return end
if !isOwner(self,this)  then return end
