...
e2function entity entity:drawSprite(string mat,vector pos,vector color,number alpha,sizex,sizey)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! drawSprite', NOTIFY_ERROR, 3 )")
	return end
...
e2function void entity:spriteSize(sizex,sizey)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! spriteSize', NOTIFY_ERROR, 3 )")
	return end
...
e2function entity entity:drawBeam(string mat,vector pos,vector endpos,vector color,number alpha,width,textstart,textend)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! drawBeam', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return nil end
	if !isOwner(self,this) then return nil end
...
e2function void entity:setBeamEndEnt(entity ent)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! setBeamEndEnt', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return end
...
e2function void entity:setBeamEndPos(vector endpos)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! setBeamEndPos', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this)  then return end
	if !isOwner(self,this)  then return end
...
e2function void entity:setBeamWidth(number width)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! setBeamWidth', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this)  then return end
	if !isOwner(self,this)  then return end
...
e2function void entity:setBeamText(number textstart,number textend)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! setBeamText', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this)  then return end
	if !isOwner(self,this)  then return end
...
e2function entity entity:drawQuad(string mat,vector pos,angle ang,vector color,number alpha,sizex,sizey)
	if tonumber(self.player:GetNWInt("e2ac")) < 3 then
		self.player:SendLua("notification.AddLegacy( 'Нужна эксеса: 3! drawQuad', NOTIFY_ERROR, 3 )")
	return end
	if !IsValid(this) then return nil end
	if !isOwner(self,this) then return nil end
