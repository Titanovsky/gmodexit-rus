...
-- Client vars
if CLIENT then
    pk_pills.convars.cl_thirdperson = CreateClientConVar("pk_pill_cl_thirdperson", 0)
    pk_pills.convars.cl_hidehud = CreateClientConVar("pk_pill_cl_hidehud", 1)
end
...
if SERVER then
    local function admin_set(ply, cmd, args)
        ...
        if not ply:GetUserGroup() == "superadmin" then
